...
interface PerformanceManagementSectionProps {
...
const PerformanceManagementSection: React.FC<PerformanceManagementSectionProps> = ({
  performances,
  loading,
  onEdit,
  onDelete
...
export default PerformanceManagementSection;
